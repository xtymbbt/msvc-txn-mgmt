...
type HttpRequest struct {
	...
	TreeUuid       string            `protobuf:"bytes,3,opt,name=tree_uuid,json=treeUuid,proto3" json:"tree_uuid,omitempty"`
	LastService    string            `protobuf:"bytes,4,opt,name=last_service,json=lastService,proto3" json:"last_service,omitempty"`
	CurrentService string            `protobuf:"bytes,5,opt,name=current_service,json=currentService,proto3" json:"current_service,omitempty"`
	NextService    string            `protobuf:"bytes,6,opt,name=next_service,json=nextService,proto3" json:"next_service,omitempty"`
	...
	Method1        bool              `protobuf:"varint,9,opt,name=method1,proto3" json:"method1,omitempty"`
	Method2        bool              `protobuf:"varint,10,opt,name=method2,proto3" json:"method2,omitempty"`
	Query          uint32            `protobuf:"varint,11,opt,name=query,proto3" json:"query,omitempty"`
	Data           map[string]string `protobuf:"bytes,12,rep,name=data,proto3" json:"data,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (x *HttpRequest) GetPos() uint32 {
	if x != nil {
		return x.Pos
	}
	return 0
...
func (x *HttpRequest) GetLastService() string {
	if x != nil {
...
func (x *HttpRequest) GetCurrentService() string {
	if x != nil {
...
func (x *HttpRequest) GetNextService() string {
	if x != nil {
...
func (x *HttpRequest) GetQuery() uint32 {
	if x != nil {
		return x.Query
	}
	return 0
...
var file_commonInfo_proto_rawDesc = []byte{
	...
	,
	...
	0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x4e, 0x61, 0x6d, 0x65,
	0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x31, 0x18, 0x09, 0x20, 0x01, 0x28,
	0x08, 0x52, 0x07, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x31, 0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65,
	0x74, 0x68, 0x6f, 0x64, 0x32, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x08, 0x52, 0x07, 0x6d, 0x65, 0x74,
	0x68, 0x6f, 0x64, 0x32, 0x12, 0x14, 0x0a, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x18, 0x0b, 0x20,
	0x01, 0x28, 0x0d, 0x52, 0x05, 0x71, 0x75, 0x65, 0x72, 0x79, 0x12, 0x2a, 0x0a, 0x04, 0x64, 0x61,
	0x74, 0x61, 0x18, 0x0c, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x48, 0x74, 0x74, 0x70, 0x52,
	...
	0x28, 0x0a, 0x0c, 0x48, 0x74, 0x74, 0x70, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x18, 0x0a, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x18, 0x01, 0x20, 0x01, 0x28, 0x08,
	0x52, 0x07, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x32, 0x3d, 0x0a, 0x0a, 0x43, 0x6f, 0x6d,
	0x6d, 0x6f, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x2f, 0x0a, 0x10, 0x73, 0x65, 0x6e, 0x64, 0x54,
	0x6f, 0x44, 0x61, 0x74, 0x61, 0x43, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x12, 0x0c, 0x2e, 0x48, 0x74,
	0x74, 0x70, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0d, 0x2e, 0x48, 0x74, 0x74, 0x70,
...
var file_commonInfo_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_commonInfo_proto_goTypes = []interface{}{
	(*HttpRequest)(nil),  // 0: HttpRequest
	(*HttpResponse)(nil), // 1: HttpResponse
	nil,                  // 2: HttpRequest.DataEntry
}
var file_commonInfo_proto_depIdxs = []int32{
	2, // 0: HttpRequest.data:type_name -> HttpRequest.DataEntry
	0, // 1: CommonInfo.sendToDataCenter:input_type -> HttpRequest
	1, // 2: CommonInfo.sendToDataCenter:output_type -> HttpResponse
